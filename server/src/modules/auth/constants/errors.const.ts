export const OTP_EXPIRED = 'Otp expired! Request for new Otp';
export const INVALID_SESSION = 'Session Expired';
...
export const OTP_VERIFICATION_IN_PROGRESS = 'OTP verification already in progress';
...
//whatsapp
export const INVALID_NUMBER = 'Invalid Number! Number must be 10 characters';
