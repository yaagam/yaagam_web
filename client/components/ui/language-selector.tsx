  ...
  return (
    <div ref={rootRef} className="relative min-w-0">
      <button
        ...
        className={cn("flex min-h-12 min-w-0 items-center gap-2 px-3 py-2 text-left text-base font-medium leading-5 transition-colors hover:text-saffron", className)}
      >
