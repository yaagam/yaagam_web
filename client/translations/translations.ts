...
const baseTranslations = {
  en: {
    ...
    hero: { trusted: "Trusted temple rituals, made accessible", line1: "Bring devotion home.", line2: "Book poojas with", description: "Join authentic rituals performed by trusted Vedic pandits at sacred temples across India.", explore: "Perform Pooja", authentic: "Authentic rituals by Vedic pandits", temples: "Sacred temples across India", secure: "Trusted and secure booking", selectBanner: "Select banner image", showBanner: "Show banner image" },
    poojasPage: {
      titleStart: "Book ",
    ...
    login: { button: "Login", welcome: "Welcome to Yaagam", phoneDescription: "Enter your WhatsApp number to receive a secure one-time password.", phoneLabel: "WhatsApp number", invalidPhone: "Enter a valid WhatsApp number with country code.", sendOtp: "Send OTP on WhatsApp", privacy: "Your number is used only for login and booking updates.", verifyTitle: "Verify your number", codeSent: "We sent a 6-digit code on WhatsApp to", codeLabel: "Verification code", invalidCode: "Enter the 6-digit verification code.", verify: "Verify & Login", changeNumber: "Change number", resend: "Resend code", success: "Successfully Logged In", sendError: "Unable to send OTP. Please try again.", verifyError: "Unable to verify OTP. Please try again." },
    card: { every: "Every", in: "in", bookNow: "Book Now", subscription: "Weekly subscription available", poojaFor: "Pooja to", spiritualWellbeing: "support devotion and spiritual wellbeing" },
    footer: { getItOn: "Get it on", quickLinks: "Quick Links", visit: "Visit Yaagam", morePoojas: "More Pujas", blogs: "Read Gyan", contact: "Contact Us", grievance: "Grievance Redressal", about: "About Us", company: "Company & Office", rights: "© 2026 Yaagam Dev-Tech Pvt. Ltd. All rights reserved.", terms: "Terms of Use", refund: "Refund & Cancellation Policy" },
  },
  ml: {
  ...
  hi: {
    ...
    login: { button: "लॉगिन", welcome: "यागम में आपका स्वागत है", phoneDescription: "सुरक्षित वन-टाइम पासवर्ड पाने के लिए अपना WhatsApp नंबर दर्ज करें।", phoneLabel: "WhatsApp नंबर", invalidPhone: "देश कोड सहित मान्य WhatsApp नंबर दर्ज करें।", sendOtp: "WhatsApp पर OTP भेजें", privacy: "आपका नंबर केवल लॉगिन और बुकिंग अपडेट के लिए उपयोग किया जाता है।", verifyTitle: "अपना नंबर सत्यापित करें", codeSent: "हमने WhatsApp पर 6 अंकों का कोड भेजा है:", codeLabel: "सत्यापन कोड", invalidCode: "6 अंकों का सत्यापन कोड दर्ज करें।", verify: "सत्यापित करें और लॉगिन करें", changeNumber: "नंबर बदलें", resend: "कोड फिर भेजें", success: "सफलतापूर्वक लॉगिन हुआ", sendError: "OTP भेजा नहीं जा सका। कृपया फिर प्रयास करें।", verifyError: "OTP सत्यापित नहीं हो सका। कृपया फिर प्रयास करें।" },
    card: { every: "हर", in: "में", bookNow: "अभी बुक करें", subscription: "साप्ताहिक सदस्यता उपलब्ध है", poojaFor: "पूजा इनके लिए", spiritualWellbeing: "भक्ति और आध्यात्मिक कल्याण" },
...
export const translations = {
  ...
  mr: {
    ...
    card: { every: "दर", in: "मध्ये", bookNow: "आता बुक करा", subscription: "साप्ताहिक सदस्यता उपलब्ध आहे", poojaFor: "पूजा यासाठी", spiritualWellbeing: "भक्ती आणि आध्यात्मिक कल्याण" },
  ...
  ta: {
    ...
    hero: { trusted: "நம்பகமான கோவில் சடங்குகள், எளிதாக அணுகலாம்", line1: "பக்தியை வீட்டிற்கு கொண்டு வாருங்கள்.", line2: "பூஜைகளை பதிவு செய்யுங்கள்", description: "இந்தியாவின் புனித கோவில்களில் தகுதியான வேத பண்டிதர்கள் நடத்தும் உண்மையான சடங்குகளில் கலந்து கொள்ளுங்கள்.", explore: "பூஜை செய்யுங்கள்", authentic: "வேத பண்டிதர்களின் உண்மையான சடங்குகள்", temples: "இந்திய முழுவதும் புனித கோவில்கள்", secure: "நம்பகமான மற்றும் பாதுகாப்பான பதிவு", selectBanner: "பேனர் படத்தைத் தேர்ந்தெடுக்கவும்", showBanner: "பேனர் படத்தை காட்டு" },
    poojasPage: {
    ...
    card: { every: "ஒவ்வொரு", in: "இல்", bookNow: "இப்போது பதிவு செய்", subscription: "வாராந்திர சந்தா கிடைக்கிறது", poojaFor: "பூஜை இதற்காக", spiritualWellbeing: "பக்தி மற்றும் ஆன்மீக நலம்" },
