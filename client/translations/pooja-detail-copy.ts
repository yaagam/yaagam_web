...
const enDetailCopy = makeDetailCopy({
  ...
  selectPlan: "Select Pooja Option", 
  ...
  weeklyFeatures: ["You can cancel weekly option any time", "Full pooja video shared with you", "Live updates via WhatsApp", "Blessed Prasad delivered to your home in every week"], 
  ...
  workflowSteps: [{ title: "Select Pooja Option", description: "You are selected a pooja option" }, { title: "Booked", description: "Your pooja is booked successfully." }, { title: "Scheduled", description: "Pooja is scheduled for the upcoming pooja day." }, { title: "Processing", description: "Pooja is in progress. Please wait for updates." }, { title: "Completed", description: "Photos and videos are sent on WhatsApp." }], 
