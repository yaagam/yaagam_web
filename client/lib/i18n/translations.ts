...
const baseTranslations = {
  en: {
    nav: { poojas: "Poojas", panchang: "Astrology", temples: 'Temples', login: "Login", selectLanguage: "Select language", openMenu: "Open navigation menu", closeMenu: "Close navigation menu", mainNavigation: "Main navigation", mobileNavigation: "Mobile navigation" },
  ...
  ml: {
    nav: { poojas: "പൂജകൾ", panchang: "ജ്യോതിഷം", temples: 'ക്ഷേത്രങ്ങൾ', login: "ലോഗിൻ", selectLanguage: "ഭാഷ തിരഞ്ഞെടുക്കുക", openMenu: "നാവിഗേഷൻ മെനു തുറക്കുക", closeMenu: "നാവിഗേഷൻ മെനു അടയ്ക്കുക", mainNavigation: "പ്രധാന നാവിഗേഷൻ", mobileNavigation: "മൊബൈൽ നാവിഗേഷൻ" },
  ...
  hi: {
    nav: { poojas: "पूजाएँ", panchang: "ज्योतिष", temples: 'मंदिर', login: "लॉगिन", selectLanguage: "भाषा चुनें", openMenu: "नेविगेशन मेनू खोलें", closeMenu: "नेविगेशन मेनू बंद करें", mainNavigation: "मुख्य नेविगेशन", mobileNavigation: "मोबाइल नेविगेशन" },
...
export const translations = {
  ...
  mr: {
    ...baseTranslations.hi,
    nav: { poojas: "पूजा", panchang: "ज्योतिष", temples: 'मंदिरे', login: "लॉगिन", selectLanguage: "भाषा निवडा", openMenu: "नेव्हिगेशन मेनू उघडा", closeMenu: "नेव्हिगेशन मेनू बंद करा", mainNavigation: "मुख्य नेव्हिगेशन", mobileNavigation: "मोबाइल नेव्हिगेशन" },
  ...
  ta: {
    ...baseTranslations.en,
    nav: { poojas: "பூஜைகள்", panchang: "ஜோதிடம்", temples: 'கோவில்கள்', login: "உள்நுழை", selectLanguage: "மொழியைத் தேர்ந்தெடுக்கவும்", openMenu: "வழிசெலுத்தல் மெனுவைத் திற", closeMenu: "வழிசெலுத்தல் மெனுவை மூடு", mainNavigation: "முதன்மை வழிசெலுத்தல்", mobileNavigation: "மொபைல் வழிசெலுத்தல்" },
